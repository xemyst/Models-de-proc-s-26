...
('Agora', 2009, (SELECT id FROM directors WHERE name='Alejandro Amenábar'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM genres WHERE name='Drama'), 7.2, (SELECT id FROM age_ratings WHERE description='PG-13'), (SELECT id FROM languages WHERE iso_code='ES')),
('The Sea Inside', 2004, (SELECT id FROM directors WHERE name='Alejandro Amenábar'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM genres WHERE name='Drama'), 8.0, (SELECT id FROM age_ratings WHERE description='PG-13'), (SELECT id FROM languages WHERE iso_code='ES')),
('The Impossible', 2012, (SELECT id FROM directors WHERE name='Juan Antonio Bayona'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM genres WHERE name='Drama'), 7.6, (SELECT id FROM age_ratings WHERE description='PG-13'), (SELECT id FROM languages WHERE iso_code='ES')),
('A Monster Calls', 2016, (SELECT id FROM directors WHERE name='Juan Antonio Bayona'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM genres WHERE name='Fantasy'), 7.5, (SELECT id FROM age_ratings WHERE description='PG-13'), (SELECT id FROM languages WHERE iso_code='ES')),
...
('Top Gun: Maverick', 'A veteran pilot trains a new generation of Top Gun fighters.', 2022, '2022-05-27', 8.3, (SELECT id FROM genres WHERE name='Action'), (SELECT id FROM directors WHERE name='Joseph Kosinski'), (SELECT id FROM countries WHERE iso_code='USA'), (SELECT id FROM languages WHERE iso_code='EN'), (SELECT id FROM age_ratings WHERE description='PG-13'), NOW() + INTERVAL '12 days'),
...
('Dark', 'A small town with a mysterious history and time travel paradoxes.', 2017, 2020, 3, 8.8, (SELECT id FROM genres WHERE name='Thriller'), (SELECT id FROM directors WHERE name='Tom Tykwer'), (SELECT id FROM countries WHERE iso_code='DEU'), (SELECT id FROM languages WHERE iso_code='DE'), (SELECT id FROM age_ratings WHERE description='R'), NOW() + INTERVAL '30 days'),
('Money Heist', 'A criminal mastermind assembles a team to pull off the biggest heist in history.', 2017, 2021, 5, 8.3, (SELECT id FROM genres WHERE name='Crime'), (SELECT id FROM directors WHERE name='Álex de la Iglesia'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM languages WHERE iso_code='ES'), (SELECT id FROM age_ratings WHERE description='R'), NOW() + INTERVAL '20 days'),
('The Mandalorian', 'A lone bounty hunter in the outer reaches of the galaxy protects a mysterious child.', 2019, 2023, 3, 8.8, (SELECT id FROM genres WHERE name='Action'), (SELECT id FROM directors WHERE name='Quentin Tarantino'), (SELECT id FROM countries WHERE iso_code='USA'), (SELECT id FROM languages WHERE iso_code='EN'), (SELECT id FROM age_ratings WHERE description='PG-13'), NOW() + INTERVAL '40 days'),
...
('BoJack Horseman', 'An anthropomorphic horse struggles with his career and personal life.', 2014, 2020, 6, 8.7, (SELECT id FROM genres WHERE name='Comedy'), (SELECT id FROM directors WHERE name='Pedro Almodóvar'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM languages WHERE iso_code='ES'), (SELECT id FROM age_ratings WHERE description='R'), DEFAULT),
('Disenchantment', 'Princess Bean explores a medieval fantasy world with friends.', 2018, 2023, 5, 7.1, (SELECT id FROM genres WHERE name='Fantasy'), (SELECT id FROM directors WHERE name='Fernando Trueba'), (SELECT id FROM countries WHERE iso_code='ESP'), (SELECT id FROM languages WHERE iso_code='ES'), (SELECT id FROM age_ratings WHERE description='PG-13'), NOW() + INTERVAL '23 days'),
...
('Kipo and the Age of Wonderbeasts', 'A girl navigates a post-apocalyptic world full of mutated animals.', 2020, 2020, 1, 8.1, (SELECT id FROM genres WHERE name='Animation'), (SELECT id FROM directors WHERE name='Hayao Miyazaki'), (SELECT id FROM countries WHERE iso_code='JPN'), (SELECT id FROM languages WHERE iso_code='JA'), (SELECT id FROM age_ratings WHERE description='PG'), NOW() + INTERVAL '19 days'),
