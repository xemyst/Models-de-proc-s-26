...
('Lupin', 'A gentleman thief inspired by Arsène Lupin seeks revenge.', 2021, 2023, 3, 7.8, (SELECT id FROM genres WHERE name='Action'), (SELECT id FROM directors WHERE name='Luc Besson'), (SELECT id FROM countries WHERE iso_code='FRA'), (SELECT id FROM languages WHERE iso_code='FR'), (SELECT id FROM age_ratings WHERE description='PG-13'), DEFAULT),
